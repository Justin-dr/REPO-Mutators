...
namespace Mutators.Mutators.Patches
{
    internal class ProtectThePresidentPatch
    {
        ...
        private static IEnumerator InitializePresidentHealthEnumerator(string presidentId)
        {
        ...
        private static void SendPresidentMeta(PlayerAvatar president)
        {
            MutatorsNetworkManager.Instance.SendMetadata(
                MutatorSettings.ProtectThePresident.NamespacedName,
                new Dictionary<string, object> { { PresidentId, president.steamID } }
            );
        }
