...
namespace Mutators.Patches
{
    ...
    internal class LoadingUIPatch
    {
        ...
        static void LoadingUIStopLoadingPostfix()
        {
            ...
            CreateAnnouncementController(hud);
        ...
        private static void CreateAnnouncementController(GameObject hud)
        {
            GameObject mutatorObject = new GameObject("Mutator Announcement Controller");
            mutatorObject.transform.SetParent(hud.transform, false);
            mutatorObject.AddComponent<MutatorAnnouncementControllerBehaviour>();
        }
