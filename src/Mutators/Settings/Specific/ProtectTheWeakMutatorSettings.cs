...
{
    /// <summary>
    /// Settings for the Protect the Weak mutator.
    /// </summary>
    public class ProtectTheWeakMutatorSettings : GenericMutatorSettings
    {
        ...
        /// <summary>
        /// The minimum amount of players required for the Protect the Weak mutator to be eligible.
        /// </summary>
        public byte MinimumPlayerCount => (byte)_minimumPlayerCount.Value;
        internal ProtectTheWeakMutatorSettings(string name, string description, ConfigFile config) : base(MyPluginInfo.PLUGIN_GUID, name, description, config)
        {
